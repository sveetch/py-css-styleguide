...
help:
	...
	@echo "  flake               -- to launch Flake8 checking on py_css_styleguide code (not the tests)"
...
clean: delpyc
	rm -Rf venv dist .tox py_css_styleguide.egg-info .cache tests/__pycache__/
...
flake:
	$(FLAKE) --show-source py_css_styleguide
